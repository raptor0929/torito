...
contract ToritoTest is Test {
    ...
    function setUp() public {
        ...
        bytes memory initData = abi.encodeWithSelector(Torito.initialize.selector, address(aavePool), owner);
    ...
    function test_InitializationRevert() public {
        ...
        vm.expectRevert();
        new TransparentUpgradeableProxy(address(newImplementation), owner, initData);
    }
